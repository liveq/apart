...
const FloorPlanCanvas = forwardRef<HTMLDivElement, FloorPlanCanvasProps>(({ measurementMode, calibrationMode, eraserMode, onCalibrationComplete }, ref) => {
  ...
  const { drawingMode, canvasWidth: drawingCanvasWidth, canvasHeight: drawingCanvasHeight, currentTool, eraserMode: drawingEraserMode } = useDrawingStore();
        ...
        >
          {uploadedImageUrl ? (
            ...
            >
              ...
              <div style={{ fontWeight: 'bold', marginBottom: '24px', fontSize: '20px' }}>도면 이미지를 업로드하세요</div>
